...
### Fixed
- Remove premature `refresh()` call after spawning processes that incorrectly marked running services as stopped.
- Add diagnostic logging to track process spawn and unexpected exits.
...
- Developer ID signing flow for macOS distribution.
- Cloudflare setup and code-signing documentation.

[1.0.2]: https://github.com/timwuhaotian/harbor/releases/tag/v1.0.2
